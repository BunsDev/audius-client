...
try {
  ...
  const REACT_APP_ANCHOR_ADMIN_STORAGE_KEYPAIR_PUBLIC_KEY = solConfigFile.anchorAdminStorageKeypairPublicKey
  ...
  REACT_APP_ANCHOR_ADMIN_STORAGE_KEYPAIR_PUBLIC_KEY=${REACT_APP_ANCHOR_ADMIN_STORAGE_KEYPAIR_PUBLIC_KEY}
